...
- 2026-09-09: KATARI is an Osaka-only, stable AIUI `0.17.0`, Page-only Local Story Agent with exactly 20 source-traceable spots. The host supplies available image/GPS/place/voice/locale evidence; the Page never opens camera, GPS, network, storage, background work, or live retrieval.
- 2026-09-09: Every KATARI match returns one paired authored Japanese/English story lasting 15–30 seconds. Location and multiple visual anchors must agree; `matched`, `uncertain`, `no_story`, `no_match`, and `invalid` keep ambiguity, missing editorial evidence, catalog boundaries, and malformed input distinct. Facts, legends, and traditions remain explicitly labelled.
- 2026-09-09: KATARI uses A · Quiet Marker: black optical floor, `#72ff9e`, one divider, no controls or motion, compact `_current`, and one memory/evidence group in `_blank`. Local logic, AIX preview, and a 30-scenario browser matrix are separate from authenticated Studio/host and physical-glasses proof; those missing layers stay `BLOCKED`.
